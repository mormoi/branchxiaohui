...
zabbix_source_code="./zabbix-2.4.2.tar.gz"
zabbix_source_code_unzip_directory="./zabbix-2.4.2/"
zabbix_deploy_directory="/oma/deploy/zabbix/"
zabbix_initial_setup_directory="${zabbix_deploy_directory}zabbix-2.4.2/"
